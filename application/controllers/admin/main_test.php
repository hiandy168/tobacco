    ...
    */
    ...
    public function start_plant(){
        ...
        if($uId){
            ...
            if($is_land_free==0){
                ...
                $result = array('code'=>0,'msg'=>'此块土地已经处在种植状态','time'=>time());
            }
        }else{
            $result = array('code'=>0,'msg'=>'没有此用户','time'=>time());
        }
    ...
    public function end_plant(){
        ...
        if($uId){
            ...
            $plant_arr = $this->plant_record_model->get_column_row('goodsId,startPlantTime', array('id'=>$plant_record_id,'uId'=>$uId));
    ...
    private function is_store_full($md5_uid){
        ...
        return $storeTotalCap-$total_num;
    }
