...
class main extends CI_Controller {
    ...
    */
    ...
    /**
     *接口名称：开始加工接口
     *接口地址：http://192.168.1.217/tobacco/index.php?d=admin&c=main&m=start_working
     *接收方式：post
     *接收参数：
     *      md5_uid：'66e16d4c71fe0616c864c5d591ab0be7' 用户加密id(暂时写死)
    ...
    /**
     *接口名称：加工结束接口
     *接口地址：http://192.168.1.217/tobacco/index.php?d=admin&c=main&m=end_working
     *接收方式：post
     *接收参数：
     *      md5_uid：'66e16d4c71fe0616c864c5d591ab0be7' 用户加密id(暂时写死)
     *      working_record_id：加工过程id
     ...
     *接口地址：http://192.168.1.217/tobacco/index.php?d=admin&c=main&m=complete_working
     *接收方式：post
     *接收参数：
     *      md5_uid：'66e16d4c71fe0616c864c5d591ab0be7' 用户加密id(暂时写死)
